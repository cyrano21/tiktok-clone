...
const styles: Record<string, React.CSSProperties> = {
  ...
  eyebrow: { color: '#fe2c55', fontSize: 11, fontWeight: 900, letterSpacing: 1.6 },
  ...
  primaryButton: { border: 0, borderRadius: 12, background: '#fe2c55', color: '#fff', padding: '12px 16px', fontWeight: 800, cursor: 'pointer' },
  ...
  cardLive: { position: 'absolute', left: 10, top: 10, background: '#fe2c55', borderRadius: 6, padding: '4px 7px', fontSize: 10, fontWeight: 900 },
  ...
  liveBadge: { marginLeft: 5, background: '#fe2c55', padding: '4px 6px', borderRadius: 5, fontSize: 10, fontWeight: 900 },
  ...
  audioButton: { border: 0, borderRadius: 999, background: '#25f4ee', color: '#051312', padding: '11px 14px', fontWeight: 850, cursor: 'pointer' },

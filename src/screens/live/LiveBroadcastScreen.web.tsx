...
const styles: Record<string, React.CSSProperties> = {
  ...
  liveDot: { width: 8, height: 8, borderRadius: 99, background: '#F72585', boxShadow: '0 0 0 4px rgba(247,37,133,.18)' },
  ...
  eyebrow: { color: '#A78BFA', fontSize: 11, fontWeight: 900, letterSpacing: 1.6 },
  ...
  primary: { width: '100%', marginTop: 14, border: 0, borderRadius: 14, padding: '14px 16px', background: '#7C3AED', color: '#fff', fontWeight: 800, cursor: 'pointer' },
  ...
  endButton: { border: 0, borderRadius: 999, padding: '11px 18px', background: '#7C3AED', color: '#fff', fontWeight: 850, cursor: 'pointer' },

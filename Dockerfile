...
ARG NEXT_PUBLIC_USE_DEMO
ARG NEXT_PUBLIC_USE_SCRAPER_FEED
ENV NEXT_PUBLIC_API_BASE_URL=${NEXT_PUBLIC_API_BASE_URL:-}
ENV NEXT_PUBLIC_SCRAPER_API_URL=${NEXT_PUBLIC_SCRAPER_API_URL:-/api/scraper}
ENV NEXT_PUBLIC_USE_DEMO=${NEXT_PUBLIC_USE_DEMO:-false}
ENV NEXT_PUBLIC_USE_SCRAPER_FEED=${NEXT_PUBLIC_USE_SCRAPER_FEED:-false}
